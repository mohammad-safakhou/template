...
func testRoleToManyPermissions(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := RoleSlice{&a}
	if err = a.L.LoadPermissions(ctx, tx, false, (*[]*Role)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testRoleToManyRoleUsers(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := RoleSlice{&a}
	if err = a.L.LoadRoleUsers(ctx, tx, false, (*[]*Role)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testRoleToManyAddOpPermissions(t *testing.T) {
	var err error
...
func testRoleToManySetOpPermissions(t *testing.T) {
	var err error
...
func testRoleToManyRemoveOpPermissions(t *testing.T) {
	var err error
...
func testRoleToManyAddOpRoleUsers(t *testing.T) {
	var err error
...
func testRoleToManySetOpRoleUsers(t *testing.T) {
	var err error
	...
	err = a.SetRoleUsers(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetRoleUsers(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
	...
	if a.R.RoleUsers[0] != &d {
		t.Error("relationship struct slice not set to correct value")
	}
	if a.R.RoleUsers[1] != &e {
		t.Error("relationship struct slice not set to correct value")
	}
}

func testRoleToManyRemoveOpRoleUsers(t *testing.T) {
	var err error
	...
	err = a.AddRoleUsers(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveRoleUsers(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
	...
	if len(a.R.RoleUsers) != 2 {
		t.Error("should have preserved two relationships")
	}

	// Removal doesn't do a stable deletion for performance so we have to flip the order
	if a.R.RoleUsers[1] != &d {
		t.Error("relationship to d should have been preserved")
	}
	if a.R.RoleUsers[0] != &e {
		t.Error("relationship to e should have been preserved")
	}
}
...
var (
	roleDBTypes = map[string]string{`ID`: `integer`, `UpdatedAt`: `timestamp without time zone`, `CreatedAt`: `timestamp without time zone`, `IsActive`: `boolean`, `Name`: `character varying`, `Description`: `character varying`}
	_           = bytes.MinRead
)
